...
public class FarmerProductsAdapter  extends RecyclerView.Adapter<FarmerProductsAdapter.ViewHolder> {

    ArrayList<Product> mItems;
    private Context context;
    public FarmerProductsAdapter(ArrayList<Product>mItems,Context context) {
        super();
