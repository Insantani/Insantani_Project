...
public class PlaceAutocompleteAdapter
    ...
    private static final String API_KEY = "AIzaSyAOdIwlRwYwFKWueHlpgXSjy66id--rd8o";
    private ArrayList<String> resultList;
    private ArrayList<String> resultListAll;
    ...
    public String getResultList(int index){
        return resultListAll.get(index);
    }
